...
export default {
  ...
  methods: {
    setUser (value) {
      ...
      // TODO: call the action 'login' from the store from the user module, and pass the username as parameter.
      // TODO: Then call the router to push the user to the login page
    }
  }
}
</script>
